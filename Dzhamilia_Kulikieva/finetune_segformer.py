...
def train_finetune(args):
    ...
    # Save full model after fine-tuning
    torch.save(model.state_dict(), model_save_dir / "segformer_best_finetuned.pth")
    print("Saved fine-tuned SegFormer to segformer_best_finetuned.pth")
